...
import { getCart, updateCartItem } from '../../services/https';
import { getProductStock } from '../../services/https';
...
interface CartPageProps {
  onCartUpdate?: () => void; // Marking it as optional
}
...
const CartPage: React.FC<CartPageProps> = ({ onCartUpdate }) => {
  ...
  const handleUpdateQuantity = async (itemId: number, quantity: number) => {
    ...
    try {
      ...
      await fetchCart();
      // Default to a no-op function if onCartUpdate is undefined
      onCartUpdate?.(); // Safe call
    } catch (error) {
