...
import { getProducts, getProductStock } from '../../services/https';
import { addToCart } from '../../services/https';
...
interface HomePageProps {
  onCartUpdate?: () => void; // Make onCartUpdate optional
}


const HomePage: React.FC<HomePageProps> = ({ onCartUpdate }) => {
  ...
  const handleAddToCart = async (product: Product) => {
    ...
    try {
      ...
      // Check if onCartUpdate is defined before calling it
      if (onCartUpdate) {
        onCartUpdate();
      }
  
      // Optionally refresh product stock
      const updatedStock = await getProductStock(product.ID);
