...
func SetupDatabase() {
	...
	product := []entity.Product{
		{Name: "BRUKSVARA บรุคส์วอร่า", 
			Description: 	"โครงเตียงแข็งแรงทนทานพร้อมเบาะรองหัวเตียงเนื้อนุ่ม ใต้เตียงยังมีพื้นที่มากมายสำหรับกล่องเก็บข้าวของเครื่องใช้ ใช้ร่วมกับสินค้าอื่นๆ จากซีรีส์ BRUKSVARA/บรุคส์วอร่า เพื่อสร้างห้องนอนแสนสบาย", 
			// Quantity: 		9,
			Image: 			"https://www.ikea.com/th/th/images/products/bruksvara-bed-frame-white__1181577_pe896708_s5.jpg?f=xl", 
			UserID: 		1, 
			CatagoryID: 	1},
		{Name: "NÄSSELKLOCKA แนสเซียคล็อกกา ปลอกผ้านวมและปลอกหมอน", 
			Description: 	"ปลอกผ้านวมทอลายซาติน มอบความวาวแววที่โดดเด่นเพิ่มความสวยงามและสัมผัสที่หรูให้กับห้องนอนของคุณ", 
			
			Image:			"https://www.ikea.com/th/th/images/products/naesselklocka-duvet-cover-and-pillowcase-light-grey-beige-multicolour__1315026_pe940361_s5.jpg?f=xl", 
			UserID: 		1, 
			CatagoryID: 	2},
		{Name: "ANTILOP อันติลูป เก้าอี้สูงพร้อมถาดวางอาหาร", 
			Description: 	"ถอดประกอบเพื่อพกพาได้ง่าย เจ้าตัวน้อยจึงนั่งอย่างปลอดภัยและมั่นคง ไม่ว่าจะอยู่ที่บ้าน บ้านเพื่อน หรือร้านอาหาร", 
			
			Image: 			"https://www.ikea.com/th/th/images/products/antilop-highchair-with-tray-white-silver-colour__0727481_pe735706_s5.jpg?f=xl", 
			UserID: 		1, 
			CatagoryID: 	3},
		{Name: "KLIPPAN คลิปปัน โซฟา2ที่นั่ง", 
			Description: 	"โซฟา KLIPPAN/คลิปปันครองใจผู้คนมากมาย ด้วยความสบาย ขนาดซึ่งนำไปตั้งได้แทบทุกที่ และผ้าหุ้มโซฟาที่มีให้เลือกหลากหลาย เรียกได้ว่าเป็นหนึ่งในสินค้าดีไซน์โมเดิร์นสุดคลาสสิกชิ้นหนึ่งจากอิเกีย", 
			
			Image: 			"https://www.ikea.com/th/th/images/products/klippan-2-seat-sofa-vansbro-black__1170083_pe892654_s5.jpg?f=xl", 
			UserID: 		1, 
			CatagoryID: 	4},
		{Name: "FRIKTION ฟริกคูน พรมเช็ดเท้าหน้าประตู", 
			Description: 	"จับกรวดทรายและสิ่งสกปรกที่ติดมาจากภายนอกและป้องกันไม่ให้เข้าไปในบ้าน", 
			
			Image: 			"https://www.ikea.com/th/th/images/products/friktion-door-mat-grey__1301896_pe937580_s5.jpg?f=xl", 
			UserID: 		1, 
			CatagoryID: 	5},
		{Name: "BRIMNES บริมเนส ตู้หนังสือ", 
			Description: 	"เก็บของรกๆ ไว้หลังบานตู้ และโชว์ของชิ้นโปรดไว้ด้านบนเลย ชั้นวางปรับได้ให้คุณปรับแต่งโซลูชันได้อย่างลงตัว", 
			
			Image: 			"https://www.ikea.com/th/th/images/products/brimnes-bookcase-white__0644268_pe702543_s5.jpg?f=xl", 
			UserID: 		1, 
			CatagoryID: 	6},
	}
	...
	tag := []entity.Tags{
		...
		{Tag_Name: "พรม"},
		{Tag_Name: "โคมไฟ"},
		{Tag_Name: "ตู้เสื้อผ้า"},
		{Tag_Name: "ประตู"},
		{Tag_Name: "ตกแต่งห้องนอน"},
		{Tag_Name: "ตกแต่งห้องนั่งเล่น"},
		{Tag_Name: "ตกแต่งห้องครัว"},
		{Tag_Name: "ตกแต่งห้องน้ำ"},
		{Tag_Name: "ตกแต่งกลางแจ้ง"},
		{Tag_Name: "อเนกประสงค์"},
		{Tag_Name: "ของขวัญ"},
		{Tag_Name: "มินิมอล"},
		{Tag_Name: "วินเทจ"},
		{Tag_Name: "พลาสติก"},
	...
	for _, pkg := range tag {
		db.FirstOrCreate(&pkg,entity.Tags{Tag_Name: pkg.Tag_Name})
	}
...
//---------------------------------------------------------------------------------------------------------------//
	...
	shippingS := []entity.ShippingStatus{
		{Status: "ขนส่งเข้ารับพัสดุแล้ว"},
		{Status: "พัสดุอยู่ระหว่างการจัดส่ง"},
		{Status: "พัสดุถูกจัดส่งเรียบร้อยแล้ว"},
	}
	for _, pkg := range shippingS {
		db.FirstOrCreate(&pkg,entity.ShippingStatus{Status: pkg.Status})
	}
	...
	catagory := []entity.Catagory{
		{Name: "เตียงนอนและที่นอน"},
		{Name: "ผ้าและสิ่งทอ"},
		{Name: "สินค้าเด็กอ่อนและเด็ก"},
		{Name: "เฟอร์นิเจอร์"},
		{Name: "พรม"},
		{Name: "อุปกรณ์จัดเก็บของใช้"},
		{Name: "ตู้ครัว และ ชุดครัว"},
		{Name: "อุปกรณ์ครัวและเครื่องใช้บนโต๊ะอาหาร"},
		{Name: "สินค้าสำหรับห้องน้ำ"},
		{Name: "ของตกแต่งบ้าน"},
		{Name: "โคมไฟ หลอดไฟและไฟประดับ"},
		{Name: "กระถางต้นไม้และต้นไม้"},
		{Name: "อุปกรณ์ซักรีดและทำความสะอาด"},
		{Name: "Home smart"},
		{Name: "เครื่องใช้ไฟฟ้าในบ้าน"},
		{Name: "อุปกรณ์แต่งบ้านและเฟอร์นิเจอร์ใช้นอกบ้าน"},
		{Name: "เครื่องมือและอุปกรณ์ซ่อมบำรุง"},
		{Name: "ผลิตภัณฑ์สำหรับสัตว์เลี้ยง"},
	}
	for _, pkg := range catagory {
		db.FirstOrCreate(&pkg,entity.Catagory{Name: pkg.Name})
	}
	// db.FirstOrCreate(User, &entity.Users{
